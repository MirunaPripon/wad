...
public class AddTableController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(!tableDAO.tableExists(tableNo)){
                tableDAO.addTable(tableNo, 1 , noOfSeats);
                msg= "Table number "+ tableNo +" successfully added!";
            }else{
                msg= "Table number "+ tableNo +" already exists!";
            }
             
            request.setAttribute("MSG", msg);
            RequestDispatcher rd = request.getRequestDispatcher("AddTables.jsp");
