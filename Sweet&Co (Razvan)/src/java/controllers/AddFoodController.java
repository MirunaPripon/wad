...
public class AddFoodController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String msg="";
            ...
            if(!foodDAO.foodExists(name)){
                foodDAO.insertFood(name,type,description,quantity,price,img);
                msg= ""+ name +" with the price "+price+" successfully added!";
            }else{
                msg= "Food named: "+ name +" already exists!";
            }
